$(document).ready(function() {
    ...
    Events.load = function() {
        genAjax("events", "get", "", function(res) {
            ...
            window.history.pushState("events", "Events | Avatar REC Banda", "/events");
            window.loader.close();
            home.close();
            events.open();
        });
    ...
    $("#av-section").ready(function() {
        var url = window.location.href;
        var temp = url.substr(url.indexOf(".")).substr(url.substr(url.indexOf(".")).indexOf("/"));
        if (temp === "/events") {
            Events.load();
        }
    });
