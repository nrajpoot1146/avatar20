...
class Background extends Item {
    constructor() {
        ...
        this.current = 0;
        this.images = [];
        this.hostname = (location.protocol === 'https:' ? 'https://' : 'http://')+window.location.hostname;
        for(let i=0;i<4;i++){
...
class Events extends Item {
    ...
    init() {
        ...
        this.eventCat["eventcat1"].modal.event[1].click(function (e) {
            window.open(window.location.href+"/autobionics/robowar", '_blank');
        ...
        this.eventCat["eventcat1"].modal.event[2].click(function (e) {
            window.open(window.location.href+"/autobionics/roborooter", '_blank');
            // genAjax("abstract", "get", {
            //     eventName: "lfr"
            // }, function (res) {
            //     window.loader.close();
        ...
        this.eventCat["eventcat1"].modal.event[3].click(function (e) {
            window.open(window.location.href+"/autobionics/speedbot", '_blank');
            // genAjax("abstract", "get", {
            //     eventName: "roborace"
            // }, function (res) {
            //     window.loader.close();
        ...
        this.eventCat["eventcat1"].modal.event[4].click(function (e) {
            window.open(window.location.href+"/autobionics/pickandplace", '_blank');
            // genAjax("abstract", "get", {
            //     eventName: "pic&drop"
            // }, function (res) {
            //     window.loader.close();
        ...
        this.eventCat["eventcat2"].modal.event[1].click(function (e) {
            window.open(window.location.href+"/codesabio/webbing", '_blank');
            // genAjax("abstract", "get", {
            //     eventName: "web"
            // }, function (res) {
            //     window.loader.close();
        ...
        this.eventCat["eventcat2"].modal.event[2].click(function (e) {
            window.open(window.location.href+"/codesabio/codecombat", '_blank');
            // genAjax("abstract", "get", {
            //     eventName: "codejam"
            // }, function (res) {
            //     window.loader.close();
        ...
        this.eventCat["eventcat2"].modal.event[3].click(function (e) {
            window.open(window.location.href+"/codesabio/dataworks", '_blank');
            // genAjax("abstract", "get", {
            //     eventName: "Ai"
            // }, function (res) {
            //     window.loader.close();
        ...
        this.eventCat["eventcat3"].modal.event[1].click(function (e) {
            window.open(window.location.href+"/electrisk/matlab", '_blank');
            // genAjax("abstract", "get", {
            //     eventName: "matlab"
            // }, function (res) {
            //     window.loader.close();
        ...
        this.eventCat["eventcat3"].modal.event[2].click(function (e) {
            window.open(window.location.href+"/electrisk/netcrumbs", '_blank');
            // genAjax("abstract", "get", {
        ...
        this.eventCat["eventcat4"].modal.event[1].click(function (e) {
            window.open(window.location.href+"/avantmechano/craneomania", '_blank');
            // genAjax("abstract", "get", {
        ...
        this.eventCat["eventcat5"].modal.event[1].click(function (e) {
            window.open(window.location.href+"/divertida/intelectiq", '_blank');
            // genAjax("abstract", "get", {
            //     eventName: "olympiad"
            // }, function (res) {
            //     window.loader.close();
        ...
        this.eventCat["eventcat5"].modal.event[2].click(function (e) {
            window.open(window.location.href+"/divertida/memewar", '_blank');
            // genAjax("abstract", "get", {
            //     eventName: "memewar"
            // }, function (res) {
            //     window.loader.close();
        ...
        this.eventCat["eventcat6"].modal.event[1].click(function (e) {
            window.open(window.location.href+"/ideation/pitch1.0", '_blank');
            // genAjax("abstract", "get", {
            //     eventName: "pitch"
            // }, function (res) {
            //     window.loader.close();
