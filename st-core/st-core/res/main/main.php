...
<body class="body">
	...
	<div id="marquee" style="z-index:21;">
		<marquee width="100%" onmouseover="this.stop();" onmouseout="this.start();" style="position:absolute; top:11%;color:white;"><b><a target="_blank" style="color:#1cb096;" href="https://avtr.org.in/ThePandemicCode/">
					<h5 style="text-shadow:5px 5px 35px white;">New event "THE PANDEMIC CODE" | <span style="color:red;">Register Now!</span></h5>
				</a></b></marquee>
	</div>
	<nav id="mainnav">
		<ul>
	...
	<div id="popUpMassage" class="animated">
		<div class="massage">
			<div class="close" onclick="this.parentElement.parentElement.style.display='none'">
				&#10006;
			</div>
			<img src="asset/img/ext/postpone34.png" alt="" width="100%" height="100%">
		</div>
	</div>
	{{footer}}
</body>
